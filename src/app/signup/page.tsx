      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-900 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-800 animate-fade-in">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSignup} autoComplete="off">
          ...
          <div className="sr-only h-0 w-0 overflow-hidden" aria-hidden="true">
            <input type="text" name="username-autofill-catch" tabIndex={-1} />
          ...
          <div className="space-y-4">
            <input
              type="text"
              required
              className="appearance-none relative block w-full px-4 py-4 bg-gray-50 dark:bg-gray-800 border-none rounded-2xl text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
