    ...
    <div className="space-y-32 pb-32 overflow-hidden">
      ...
      <section className="relative pt-32 pb-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Join 12,000+ students worldwide who trust BSt for premium assignments, complex FYPs, and expert research guidance. 
            Standardized for Global Universities.
          </motion.p>
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="bg-gradient-to-br from-gray-900 to-black rounded-[4rem] p-12 md:p-24 text-center text-white relative overflow-hidden shadow-3xl shadow-purple-500/10">
          ...
          <h2 className="text-5xl md:text-7xl font-black mb-8 relative tracking-tighter leading-[0.9]">Ready to <br />Elevate Your Grades?</h2>
          <p className="text-gray-400 text-xl max-w-2xl mx-auto mb-12 relative font-medium">
            Join the elite circle of students who prioritize quality and expertise. 
            Get a professional quote for your academic project today.
          </p>
