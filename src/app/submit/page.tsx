      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col md:flex-row items-center gap-10 mb-16 bg-white/50 dark:bg-white/5 backdrop-blur-2xl p-10 rounded-[3.5rem] border border-white/20 shadow-2xl">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-5xl font-black tracking-tighter mb-2">Initialize Project</h1>
            <p className="text-gray-600 dark:text-gray-400 text-lg font-medium">Standardized submission for Global University Curricula.</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-12 bg-white dark:bg-gray-900 p-10 md:p-20 rounded-[4rem] shadow-3xl border border-gray-100 dark:border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-2">Academic Title</label>
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-2">Global Deadline</label>
                <div className="relative">
            ...
            <div className="space-y-8">
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-2">Detailed Mandate</label>
                <textarea
                  required
                  rows={8}
          ...
          {/* File Upload Zone */}
          <div className="space-y-3">
            <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-2">Research Materials (PDF, ZIP, DOCX)</label>
          ...
          >
            {loading ? <Loader2 className="animate-spin" size={28} /> : <>Initiate Transmission <Send size={24} /></>}
          </button>
        </form>
      </div>
    </div>
